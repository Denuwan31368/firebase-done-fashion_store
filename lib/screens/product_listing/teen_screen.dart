...
class TeenScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: _buildCustomAppBar(context, "Teen"),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('products_teens').snapshots(),
        builder: (context, snapshot) {
          ...
          if (documents.isEmpty) {
            return const Center(child: Text("No products found in Kids section"));
          }
                ...
                Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      Product product =
                          Product.fromFirestore(data, documents[index].id);
